...
//                .into(viewHolder.mIv_pic, new com.squareup.picasso.ItemCallback() {
//                    @Override
...
public  class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.ViewHolder> implements View.OnClickListener {
    ...
    private static final String IMAGE_BASE_URL = "https://image.tmdb.org/t/p/w500";
    private static final String IMAGE_BASE_URL2 = "https://image.tmdb.org/t/p/w185";
    private OnRecyclerViewItemClickListener mOnItemClickListener = null;
    ...
    public void setClickItemPosition(int mLastItemPosition) {
        this.mLastItemPosition = mLastItemPosition;
    }
    ...
    public List<MovieResult.MovieInfo> getData(){
        return movies;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if(mTwoPanel){
            ...
            Picasso.with(mContext)
                    ...
                    .placeholder(R.mipmap.ic_launcher)
                    .into(viewHolder.mIv_pic2, new com.squareup.picasso.Callback() {
                        @Override
                        public void onSuccess() {
//                            Toast.makeText(mContext,"加载成功",Toast.LENGTH_SHORT).show();
                        }
...
//                            Toast.makeText(mContext,"信息暂时无法加载",Toast.LENGTH_SHORT).show();
    ...
    public MovieResult.MovieInfo getItem(int position){
    ...
    public void onClick(View view) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick((Integer) view.getTag(),view,getItem((Integer) view.getTag()));
        }
    }
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view){
            ...
            mTv_title = (TextView) view.findViewById(R.id.movie_title);
            mIv_pic = (ImageView) view.findViewById(R.id.movie_pic);
            mIv_pic2=(ImageView)view.findViewById(R.id.movie_pic2);
        }
    ...
    //define interface
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(int position ,View view , MovieResult.MovieInfo data);
    }
}
